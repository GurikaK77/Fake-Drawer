...
const wordData = {
    "mix": ["ვაშლი", "მანქანა", "სახლი", "მზე", "თვითმფრინავი", "ყვავილი", "ხე", "ჭიქა", "გული", "ვარსკვლავი", "ნავი", "ბურთი", "თევზი", "ტელეფონი"],
    "objects": ["ტელეფონი", "სკამი", "საათი", "სათვალე", "ქუდი", "ბურთი", "წიგნი", "გასაღები", "ლამპა", "ფეხსაცმელი"],
    "animals": ["კატა", "ძაღლი", "სპილო", "ჟირაფი", "თევზი", "პეპელა", "ობობა", "გველი", "კუ", "დათვი"],
    "places": ["მთა", "ზღვა", "ტყე", "პარკი", "სკოლა", "საავადმყოფო", "მაღაზია", "ხიდი", "პლაჟი", "ქალაქი"]
};
