...
const wordData = {
    "mix": [
        ...
        "თავის ქალა", "ჩონჩხი", "უცხოპლანეტელი", "მონსტრი", "ვამპირი", "ჯადოქარი", "ფერია", "ქალთევზა", "ანგელოზი", "ეშმაკი", "მეფე", "დედოფალი", "რაინდი", "მეკობრე", "ნინძა", "კლოუნი", "ექიმი", "პოლიციელი", "მეხანძრე", "ჯარისკაცი", "მასწავლებელი", "ბავშვი", "მოხუცი",
        "პიცა", "ბურგერი", "კვერცხი", "ყველი", "პური", "შოკოლადი", "კანფეტი", "საზამთრო", "ყურძენი", "ბანანი", "ლიმონი", "მარწყვი", "ალუბალი", "ანანასი", "სოკო", "კაქტუსი", "პალმა", "ვარდი",
        "მზე და მთვარე", "დღე და ღამე", "სიყვარული", "ომი", "მშვიდობა", "დრო", "იდეა", "ოცნება", "კოშმარი", "სიკვდილი", "სიცოცხლე"
    ],
    "objects": [
        ...
        "ჩაქუჩი", "სახრახნისი", "ხერხი", "ბურღი", "კიბე", "უნიტაზი", "აბაზანა", "ნიჟარა", "ონკანი", "კბილის პასტა", "შამპუნი", "სარეცხი ფხვნილი", "ტუალეტის ქაღალდი", "სარწყავი", "ქოთანი",
        "ჩექმა", "წინდა", "ხელთათმანი", "შარფი", "ქამარი", "ჰალსტუხი", "კაბა", "შარვალი", "პერანგი", "ქურთუკი", "საცურაო კოსტუმი",
        "ტელესკოპი", "მიკროსკოპი", "კალკულატორი", "რადიო", "ელემენტი", "ნათურა", "ჩამრთველი", "შტეფსელი", "ასანთი", "სანთებელა", "ბოქლომი", "კარი", "ფანჯარა", "სახურავი", "საკვამური", "ღობე", "ჭიშკარი", "ნაგვის ურნე",
        "მტვერსასრუტი", "უთო", "სარეცხი მანქანა", "მაცივარი", "ღუმელი", "მიკროტალღური", "ტოსტერი", "ბლენდერი", "ჩაიდანი", "ყავის აპარატი",
        "ბოთლი", "ქილა", "ყუთი", "კონვერტი", "მარკა", "მონეტა", "ბანკნოტი", "სავიზიტო ბარათი", "პასპორტი", "ბილეთი", "რუკა", "გლობუსი", "კომპასი", "ქოლგა", "ჯოხი", "ეტლი", "აკვანი"
    ],
    "animals": [
        ...
        "კენგურუ", "პინგვინი", "ღამურა", "კიბორჩხალა", "მედუზა", "მარტორქა", "აქლემი", "ლამა", "ფარშევანგი", "ფლამინგო", "გედი", "ბატი", "ინდაური", "მტრედი", "ყვავი", "კოდალა",
        "დინოზავრი", "დრაკონი", "ზაზუნა", "ვირთხა", "თაგვი", "პანდა", "კოალა", "ენოტი", "თახვი", "წავი", "სელაპი", "მორჟი",
        "მორიელი", "კოღო", "ბუზი", "ჭიაყელა", "კალია", "ხოჭო", "ჭიამაია", "ობობას ქსელი", "ბუდე", "კვერცხი (ცხოველის)", "ბრჭყალები", "ეშვი", "ხორთუმი", "რქა"
    ],
    "places": [
        ...
        "პოლიცია", "სახანძრო", "ფოსტა", "ბანკი", "სასტუმრო", "პორტი", "შუქურა", "ფერმა", "ბეღელი", "წისქვილი", "ქარხანა", "ელექტროსადგური", "ავტოფარეხი", "საპარიკმახერო", "აფთიაქი",
        "პირამიდა", "იგლუ", "კარავი", "ცათამბჯენი", "კოშკი", "გვირაბი", "გზა", "გზაჯვარედინი", "ავტობუსის გაჩერება", "მეტრო",
        "სათამაშო მოედანი", "სპორტდარბაზი", "ჯუნგლები", "ჭაობი", "კანიონი", "აისბერგი", "მინდორი", "ვენახი",
        "კოსმოსური ხომალდი", "მთვარე", "მარსი", "ვარსკვლავი", "ცა", "ჯოჯოხეთი", "სამოთხე", "საფლავი", "სასაფლაო", "ციხე (საპყრობილე)", "ლაბორატორია", "ოფისი", "საკლასო ოთახი"
    ]
};
